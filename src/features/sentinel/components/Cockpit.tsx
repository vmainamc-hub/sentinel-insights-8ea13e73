...
export function Cockpit() {
  const { tradeSheetOpen, setTradeSheetOpen } = useCockpit();
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      {/* Main Cockpit Body */}
      <main className="flex-1 p-2 sm:p-3 max-w-[1720px] w-full mx-auto grid grid-cols-1 xl:grid-cols-12 gap-2.5 sm:gap-3">
